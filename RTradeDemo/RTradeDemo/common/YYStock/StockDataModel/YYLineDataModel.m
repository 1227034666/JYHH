...
- (NSString *)Day {
    ...
    if ([day hasSuffix:@"1129"]) {
        return [NSString stringWithFormat:@"%@%@",[day substringToIndex:8],@"1130"];
    }
//    return [NSString stringWithFormat:@"%@-%@",[day substringToIndex:4],[day substringWithRange:NSMakeRange(4, 2)]];
    return [_dict[@"day"] stringValue];
}

- (NSString *)DayDatail {
    NSString *day = [_dict[@"day"] stringValue];
    return [NSString stringWithFormat:@"%@-%@-%@ %@:%@",[day substringToIndex:4],[day substringWithRange:NSMakeRange(4, 2)],[day substringWithRange:NSMakeRange(6, 2)],[day substringWithRange:NSMakeRange(8, 2)],[day substringWithRange:NSMakeRange(10, 2)]];
}
...
- (BOOL)isShowDay {
    return [[_dict[@"day"] stringValue] hasSuffix:@"0900"]||[[_dict[@"day"] stringValue] hasSuffix:@"1129"]||[[_dict[@"day"] stringValue] hasSuffix:@"2100"];
}
